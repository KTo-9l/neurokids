...
async function fetchOrCreateCourseUser() {
    const url = `http://10.243.55.208:8085/getCourseUserByCourseId?courseId=${courseId}`;
    ...
    try {
        ...
        if (response.status === 404 || text === "null") {
            ...
            const createRes = await fetch("http://10.243.55.208:8085/createCourseUser", {
                method: "POST",
                headers: {
...
function markLessonOpened(lessonNumber, isLast = false) {
    ...
    fetch("http://10.243.55.208:8085/updateCourseUser", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
            "X-user-id": USER_ID
...
async function markTestFinished(testId, correctCount) {
    try {
        const res = await fetch(`http://10.243.55.208:8085/getTestUserByTestId?testId=${testId}`, {
            method: "GET",
            headers: {
                "x-user-id": USER_ID
            }
        ...
        await fetch("http://10.243.55.208:8085/updateTestUser", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                "x-user-id": USER_ID
