module courseUser/getCourseUserByCourseId

go 1.24.6

replace courseUser/models => ../models

replace dikobra3/mongoApi => ../../mongo/mongoApi

replace dikobra3/utils => ../../utils

replace auth_helpers => ../../auth_helpers

replace github.com/big-larry/mgo => ../../mongo/mgo@v1.0.0

require (
	auth_helpers v0.0.0-00010101000000-000000000000
	courseUser/models v0.0.0-00010101000000-000000000000
